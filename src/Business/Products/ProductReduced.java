...
/**
 * The ProductReduced class represents a specific type of product with additional attributes
 * such as a discount, extending the base Product class.
 *
 * @author Bruno Bordoy, Guillem Gil
 * @version 13/11/2023
 */
public class ProductReduced extends Product{
    private float discount;
    /**
     * Constructor for creating a ProductReduced with specified attributes.
     *
     ...
     */
    public ProductReduced(String name, String brand, String category, float priceMax, ArrayList<String> reviewList) {
