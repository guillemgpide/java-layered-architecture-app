...
/**
 * The ProductGeneral class represents a general type of product with additional attributes
...
public class ProductGeneral extends Product{
    ...
    /**
     * Constructor for creating a ProductGeneral with specified attributes.
     *
     ...
     */
    public ProductGeneral(String name, String brand, String category, float priceMax, ArrayList<String> reviewList) {
